  ...
  USERS: [
    {
      ...
      name: "YoYo",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oe4i45mNt7EBuHc-i3dBDEUZgHOw",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "y9TR3a4RVIbDqlsuazRQi04UZd0AMsTDx6oMcatHPxk",
      // 所在省份
      province: "浙江",
      // 所在城市
      city: "台州",
...
//     }, 
  ...
  CUSTOMIZED_DATE_LIST: [
    // 在一起的日子
    {"keyword": "love_day", date: "2022-02-05"},
    // 结婚纪念日
  ...
  SLOT_LIST: [
    // 这样配置的话，就会每次发送这句话
    {"keyword": "encourage_oneself", contents: "UU 今天吃的多吗!!!!!!"},
    // 这样配置的话，就会每次随机选一句话发送
